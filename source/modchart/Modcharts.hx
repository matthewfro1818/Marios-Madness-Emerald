        ...
        if (!ClientPrefs.middleScroll){
            ...
            switch (songName.toLowerCase()){
                case 'all-stars':
                    ...
                    modManager.queueSet(2240, "transformX", 0, 0);
                    modManager.queueSet(2240, "transformX", 1500, 1);
                    /*if (!ClientPrefs.middleScroll){
                        modManager.queueSet(2240, "alpha", 1, 1);
                    }*/
                    ...
                    modManager.queueSet(4800, "transformX", 1500, 1);
                ...
                default:
                    if(ClientPrefs.middleScroll){
                        modManager.setValue("opponentSwap", 0.35);
                        modManager.setValue("alpha", 1, 1);
                    }
                    PlayState.songIsModcharted = false;
