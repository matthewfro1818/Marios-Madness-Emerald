...
class MainMenuState extends MusicBeatState {
	...
	function goToState() {
		...
		if(menuInfo[currentLevel].choices[curSelected] == "Freeplay"){
			FlxTween.color(bgFP, 0.6, bgFP.color, 0xFF1900FF, {startDelay: 0.5});
	...
	function newBG(newAm:Int){
		...
		screenText.setFormat(Paths.font("mariones.ttf"), 24, 0xFF1900FF, CENTER);
		add(screenText);
