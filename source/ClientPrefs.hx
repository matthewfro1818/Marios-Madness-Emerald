...
class ClientPrefs {
	...
	public static var shadersToggle:Bool = true;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.shadersToggle = shadersToggle;
	...
	public static function loadPrefs() {
		...
		if (FlxG.save.data.shadersToggle != null) {
			shadersToggle = FlxG.save.data.shadersToggle;
		}
