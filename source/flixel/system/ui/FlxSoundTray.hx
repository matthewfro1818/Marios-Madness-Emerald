...
class FlxSoundTray extends Sprite
{
	...
	public function new()
	{
		...
		#else
		#end
		var dtf:TextFormat = new TextFormat(Assets.getFont(Paths.font("mariones.ttf")).fontName, 7, 0xff1ba122);
		...
		for (i in 0...10)
		{
			tmp = new Bitmap(FlxGradient.createGradientBitmapData(4, i + 1, [0xff04cb1f, 0xff1ba122, 0xff1ba12d, 0xff1b7818, 0xff187820]));
			tmp.x = bx;
			tmp.y = by;
			addChild(tmp);
			_bars.push(tmp);
